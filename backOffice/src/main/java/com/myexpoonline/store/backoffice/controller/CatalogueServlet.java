...
public class CatalogueServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        //Je récupère les données de la sessions
        HttpSession session = request.getSession();
        String idendifiant = (String) session.getAttribute("username");
        ...
        out.println("</head>");
        out.println("<body>"); 
        out.println("<h1> Bonjour : " + idendifiant + " (<a href='logout'>Deconnexion</a>)</h1>"); 
        out.println("<h1>Voici la liste de nos oeuvres : "+nbrSession + "</h1>");
